...
The multiple alignment below shows that a) left and right arms of the Kume alignments
match the Okinawa genome, and b) there is a tandem site duplication at the break.
...
list(
  ...
  oki_left  = getSeq(genomes$Oki, ROI1[2] |> flank(20, both = T, start = F))[[1]]
...
Let's inspect within-population alignments first.
...
alignFlank2 <- function(gb, qGenome=genomes$Kum, n = 6) {
  # Remove 1-bp padding
  gb$query <- gb$query -1
