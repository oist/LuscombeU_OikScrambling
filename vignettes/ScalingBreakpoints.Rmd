...
=======
**The vignette also produce trees for panels 7A–D.**
>>>>>>> b98c9ce383ea866209a035712da1a369b9ab13ba
...
plotTree <- function(sp) {
  ggtree(sp, ladderize=T) +
    ...
    geom_treescale(width = 0.02) + geom_rootedge()
}
```
...
Caeno4 <-  drop.tip(species$Caenorhabditis, which(!species$Caenorhabditis$tip.label %in% c('CELEG', 'CREMA', 'CNIGO', 'CBRIG')))

species$Caenorhabditis$tip.label <- c('Cel', 'Cin', 'Cre', 'Cni', 'Cbr')
Caeno4$Caenorhabditis$tip.label <- c('Cel', 'Cre', 'Cni', 'Cbr')

write.tree(species$Caenorhabditis)
species$Caenorhabditis <- as.treedata(species$Caenorhabditis)
Caeno4 <- as.treedata(Caeno4)
...
=======
```{r species_trees_Caeno4, fig.height=6, fig.width=6, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
plotTree(Caeno4)
>>>>>>> b98c9ce383ea866209a035712da1a369b9ab13ba
```
...
```{r breakpoints_fun, dependson="breakpoints_1", fig.height=3, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
...
## Panel used for Figure 7

```{r breakpoints_main_figure, dependson="breakpoints_fun", fig.height=3, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}

# Show the nematodes between Oiks and ascidians.

mya_df$pair <- mya_df$pair |> factor(c("Dme_Dbu", "Dme_Dsu", "Dme_Dya",
  "Ply_Sav", "Rob_Sav", "Ply_Rob", "Rob_Ros", "Ply_Ros",
  "Cni_Cin", "Cbr_Cel", "Cni_Cre", "Cbr_Cre", "Cni_Cbr", "Cbr_Cni",
  "Osa_Oki", "Oki_Bar", "Osa_Bar", "Bar_Aom", "Osa_Aom", "Oki_Kum"))

customPlot(mya_df, 'breakpoints_per_mbp_scaled', 'Number of breakpoints per megabase per million years diverged')
```

## Supplemental panels for figure 7

```{r breakpoints_2, dependson="breakpoints_fun", fig.height=3, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
