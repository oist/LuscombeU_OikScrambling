...
species$Caenorhabditis <-  "(Rem:1,(Bri:1,Nig:1)100:1,Ino:1);" |> toTreedata()
...
mya_df <- rbind(
  ...
  bp_vs_dist(query="Nig", target="Bri", wgo$Nig_Bri, dist_type="mya", "Caenorhabditis"),
  bp_vs_dist(query="Nig", target="Rem", wgo$Nig_Rem, dist_type="mya", "Caenorhabditis"),
  bp_vs_dist(query="Nig", target="Ino", wgo$Nig_Ino, dist_type="mya", "Caenorhabditis")
)
mya_df$species <- factor(mya_df$species, levels=c("Caenorhabditis","Drosophila", "Ciona", "Oikopleura"))
mya_df$pair <- factor(mya_df$pair,
                      levels=c("Nig_Ino", "Nig_Rem", "Nig_Bri",
...
sub_df <- rbind(
  ...
  bp_vs_dist(query="Nig", target="Ino", wgo$Nig_Ino, dist_type="cophenetic", "Caenorhabditis"),
  bp_vs_dist(query="Nig", target="Rem", wgo$Nig_Rem, dist_type="cophenetic", "Caenorhabditis"),
  bp_vs_dist(query="Nig", target="Bri", wgo$Nig_Bri, dist_type="cophenetic", "Caenorhabditis")
)
