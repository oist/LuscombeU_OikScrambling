...
translocation_percent_table <- function(gb, name){
  data.frame('name'                          = name,
             ...
             'percent_nonsyntenic_synbrachial'        = length(gb[isNonsyntenicSynbrachial(gb)])/length(gb)*100,
             'percent_nonsyntenic_synbrachial_length' = sum(lengths(gb[isNonsyntenicSynbrachial(gb)]))/sum(lengths(gb))*100,
             'percent_nonsyntenic_nonsynbrachial'        = length(gb[isNonsyntenicNonsynbrachial(gb)])/length(gb)*100,
             'percent_nonsyntenic_nonsynbrachial_length' = sum(lengths(gb[isNonsyntenicNonsynbrachial(gb)]))/sum(lengths(gb))*100)
}
