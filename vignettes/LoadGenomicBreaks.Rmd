...
gbs <- annotateWithTranscripts(gbs, annots)
...
unal[ 1:5 ] <- BiocParallel::bplapply(unal[ 1:5 ], annotateWithTranscripts, annots$Oki)
unal[ 6:10] <- BiocParallel::bplapply(unal[ 6:10], annotateWithTranscripts, annots$Osa)
unal[11:15] <- BiocParallel::bplapply(unal[11:15], annotateWithTranscripts, annots$Bar)
```
...
coa <- annotateWithTranscripts(coa, annots)
...
unmap[ 1:5 ] <- BiocParallel::bplapply(unmap[ 1:5 ], annotateWithTranscripts, annots$Oki)
unmap[ 6:10] <- BiocParallel::bplapply(unmap[ 6:10], annotateWithTranscripts, annots$Osa)
unmap[11:15] <- BiocParallel::bplapply(unmap[11:15], annotateWithTranscripts, annots$Bar)
```
...
unalMap <- annotateWithTranscripts(unalMap, annots)
...
tra <- annotateWithTranscripts(tra, annots)
...
coa2 <- annotateWithTranscripts(coa2, annots)
...
unmap2[ 1:5 ] <- BiocParallel::bplapply(unmap2[ 1:5 ], annotateWithTranscripts, annots$Oki)
unmap2[ 6:10] <- BiocParallel::bplapply(unmap2[ 6:10], annotateWithTranscripts, annots$Osa)
unmap2[11:15] <- BiocParallel::bplapply(unmap2[11:15], annotateWithTranscripts, annots$Bar)
```
...
tra2 <- annotateWithTranscripts(tra2, annots)
