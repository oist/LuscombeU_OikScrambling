...
gbs$Oki_Nor$rep <- gbs$Oki_Nor$query$rep <- NA
...
gbs$Osa_Nor$rep <- gbs$Osa_Nor$query$rep <- NA
...
gbs$Bar_Nor$rep <- gbs$Bar_Nor$query$rep <- NA
```
...
unalMap$Oki_Nor$rep <- unalMap$Oki_Nor$query$rep <- NA
...
unalMap$Osa_Nor$rep <- unalMap$Osa_Nor$query$rep <- NA
...
unalMap$Bar_Nor$rep <- unalMap$Bar_Nor$query$rep <- NA
```
...
tra$Oki_Osa <- tra$Oki_Osa |> annotateWithReps.GBreaks(reps$Oki, reps$Osa)
tra$Oki_Bar <- tra$Oki_Bar |> annotateWithReps.GBreaks(reps$Oki, reps$Bar)
tra$Oki_Kum <- tra$Oki_Kum |> annotateWithReps.GBreaks(reps$Oki, reps$Kum)
tra$Oki_Aom <- tra$Oki_Aom |> annotateWithReps.GBreaks(reps$Oki, reps$Aom)
tra$Oki_Nor$rep <- tra$Oki_Nor$query$rep <- NA

tra$Osa_Oki <- tra$Osa_Oki |> annotateWithReps.GBreaks(reps$Osa, reps$Oki)
tra$Osa_Bar <- tra$Osa_Bar |> annotateWithReps.GBreaks(reps$Osa, reps$Bar)
tra$Osa_Kum <- tra$Osa_Kum |> annotateWithReps.GBreaks(reps$Osa, reps$Kum)
tra$Osa_Aom <- tra$Osa_Aom |> annotateWithReps.GBreaks(reps$Osa, reps$Aom)
tra$Osa_Nor$rep <- tra$Osa_Nor$query$rep <- NA

tra$Bar_Oki <- tra$Bar_Oki |> annotateWithReps.GBreaks(reps$Bar, reps$Oki)
tra$Bar_Osa <- tra$Bar_Osa |> annotateWithReps.GBreaks(reps$Bar, reps$Osa)
tra$Bar_Kum <- tra$Bar_Kum |> annotateWithReps.GBreaks(reps$Bar, reps$Kum)
tra$Bar_Aom <- tra$Bar_Aom |> annotateWithReps.GBreaks(reps$Bar, reps$Aom)
tra$Bar_Nor$rep <- tra$Bar_Nor$query$rep <- NA
```
