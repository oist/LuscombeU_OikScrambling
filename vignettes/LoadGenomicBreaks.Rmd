...
gbs$Nig_Bri <- load_genomic_breaks("/bucket/LuscombeU/live/CharlesPlessy/GenomesToCompare/Caenorhabditis/nigoni_briggsae/results/last/query.07.postmasked.maf.gz")
gbs$Nig_Rem <- load_genomic_breaks("/bucket/LuscombeU/live/CharlesPlessy/GenomesToCompare/Caenorhabditis/nigoni_remanei/results/last/query.07.postmasked.maf.gz")
gbs$Nig_Ino <- load_genomic_breaks("/bucket/LuscombeU/live/CharlesPlessy/GenomesToCompare/Caenorhabditis/nigoni_inopinata/results/last/query.07.postmasked.maf.gz")
```
