...
dsList4 <- c(
    list(KUM = KumChr2 |> plyranges::filter(seqnames == 'chr2', seqnames(query) == 'chr2') |> gr2dna_seg()),
    dsList
)

compList4 <- list(
    Oki_Kum = KumChr2 |> plyranges::filter(seqnames == 'chr2', seqnames(query) == 'chr2') |> gb2comp(),
    Oki_Osa = compList[[1]],
