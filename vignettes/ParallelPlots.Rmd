...
x$query <- mergeSeqLevels(x$query, c("contig_27_1", "contig_90_1", "contig_3_1", "contig_88_1"), "chr1")
...
Chromosome 2 is mostly comprised of `contig_16_1`, `contig_24_1` on the short arm,
and the reverse complement of `contig_79_1`, `contig_37_1`, `contig_81_1` on the
long arm.
...
x$query <- mergeSeqLevels(x$query, c("contig_16_1", "contig_24_1", "contig_79_1", "contig_37_1", "contig_81_1"), "chr2")
plotApairOfChrs(x, "chr2", dna_seg_scale=TRUE, main = "Oki vs Kum")
```
