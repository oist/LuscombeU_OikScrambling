...
```{r Oki_Osa_gbs}
makeOxfordPlots(gbs$Oki_Osa, diag = FALSE) + theme_bw() + theme(legend.position="none")
```
...
```{r Oki_Osa_win, dev='svg', fig.ext='svg'}
...
```{r Osa_Oki_win, dev='svg', fig.ext='svg'}
...
```{r Osa_Aom_win, dev='svg', fig.ext='svg'}
