...
Same, using collinear regions from the `coa` object (we used to call these
regions 'coalesced' in a earlier phase of the project).  Visually, the two
line plots are very similar.

```{r Oki_Osa_strand_coa, dev=c('png', 'svg', 'pdf'), fig.ext=c('png', 'svg', 'pdf')}
