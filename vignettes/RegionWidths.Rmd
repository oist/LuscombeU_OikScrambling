...
p_hist <- gg_freq_poly(widths$coa |> dplyr::filter(dist == "Oki – North")) +
  aes(col=name) +
  facet_wrap(~dist, scales = "free_y", nrow = 1) +
  ggtitle("Distribution of mapped region widths (vline at 600)") +
  geom_vline(xintercept = 600)

p_hist

# The cutoff at 600 is good enough for both arms
p_hist + facet_wrap(~Arm)
p_hist + facet_wrap(~nonCoa + Arm)
```
