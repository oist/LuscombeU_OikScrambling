...
```{r compound1_alignment_classes_part, fig.width=10, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
library(dplyr)
...
wfreq |>
  ...
  scale_x_continuous(limits = c(0, 5e2)) + theme_bw()

# Default smoothing because loess is to slow
...
wfreq |>
  ...
  aes(width, prop, col = aliclass) +
  geom_smooth(fill = NA) +
  scale_x_continuous(limits = c(1e3, 1e5)) + theme_bw()
```
...
```{r compound2, fig.width=20, fig.height=4, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r compound3, fig.width=20, fig.height=4, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r compound4, fig.width=20, fig.height=4, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r compound_all, fig.width=20, fig.height=10, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
p_oki_north    /
p_north_north  /
p_same_pop
```
