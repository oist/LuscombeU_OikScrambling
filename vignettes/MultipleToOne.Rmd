...
```{r flagging_correspondence_4, fig.width=8, fig.height=12, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
# Okinawa
tmp <- do.call(
  rbind,
  lapply(list("Oki_Osa", "Oki_Bar", "Oki_Kum"), function(pair) compare_m2o_wgo_all(pair, m2o_gr, "original01", wgo))
)
...
rbind(
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("one_to_one"), gb=coa$Oki_Osa[coa$Oki_Osa$nonCoa==FALSE], gb_name="collinear region"),
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("many_to_many"), coa$Oki_Osa[coa$Oki_Osa$nonCoa==FALSE], gb_name="collinear region"),
  
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("one_to_one"), gb=coa$Oki_Osa[coa$Oki_Osa$nonCoa==TRUE], gb_name="isolated alignment"),
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("many_to_many"),  gb=coa$Oki_Osa[coa$Oki_Osa$nonCoa==TRUE], gb_name="isolated alignment"),
  
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("one_to_one"), gb=unal$Oki_Osa, gb_name="breakpoint region"),
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("many_to_many"), gb=unal$Oki_Osa, gb_name="breakpoint region"),
  
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("one_to_one"), gb=bri$Oki_Osa, gb_name="bridge region"),
  compare_m2o_gb(pair="Oki_Osa", m2o_obj=m2o_gr, m2o_align="original01", m2o_category=c("many_to_many"), gb=bri$Oki_Osa, gb_name="bridge region")
)
```
...
unaligned_but_corresponding <- sapply(names(m2o_gr$original01), function(pair) {
  subsetByOverlaps(unal[[pair]], m2o_gr$original01[[pair]], invert=F) |> width() |> sum()
})
(unaligned_but_corresponding)

unaligned_not_corresponding <-sapply(names(m2o_gr$original01), function(pair) {
  subsetByOverlaps(unal[[pair]], m2o_gr$original01[[pair]], invert=T) |> width() |> sum()
})
(unaligned_not_corresponding)

(unaligned_not_corresponding/(unaligned_not_corresponding+unaligned_but_corresponding)*100)
(unaligned_but_corresponding/(unaligned_not_corresponding+unaligned_but_corresponding)*100)
...
```{r plot_correspondence_1, fig.width=8, fig.height=12, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r plot_correspondence_2, fig.height=8, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
