...
#many_to_one <- lapply(list.files('../../Alignments/1_converted_maf_03.split/Oidioi_v3/'), function(x)load_genomic_breaks(paste0('../../Alignments/1_converted_maf_03.split/Oidioi_v3/', x))) |> SimpleList()
#names(many_to_one) <- sapply(list.files('../../Alignments/1_converted_maf_03.split/Oidioi_v3/'), function(s) unlist(strsplit(s, '.gff3'))[1])
...
#m2o <- list(c("03.split", "05.split", "07.split"))
