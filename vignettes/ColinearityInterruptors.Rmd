...
coa$Oki_Kum |> plyranges::filter(seqnames(query) == "contig_3_1",
                                 start > 8000000,
                                 end(query) <= 21079) |> plotApairOfChrs("chr1", dna_seg_scale=TRUE)

coa$Oki_Kum |> plyranges::filter(start > 3838000, end <= 3891000) |> plotApairOfChrs("chr1", dna_seg_scale=TRUE)

getSeq(genomes$Kum, GRanges("contig_3_1:16561-16812"), as.character=TRUE)
