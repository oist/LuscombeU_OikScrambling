...
Figure 2 panel A and Supplemental figure 2 were generated in this
vignette.
...
```{r synteny_block_histogram_functions}
...
```{r synteny_block_histograms, fig.width=10, fig.height=10, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
# Close
...
```{r synteny_block_histograms_2, fig.width=10, fig.height=10, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
