...
Load all of the necessary objects beforehand.
...
```
ggplot(tibble(as.data.frame(dndsPairs$Oki_Osa))) +
  aes(dNdS, fill=Arm) +
  geom_boxplot() +
  coord_flip() +
  facet_wrap(~seqnames) +
...
```
ggplot(tibble(as.data.frame(dndsPairs$Oki_Osa)) %>% filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR', 'YSR'))) +
  aes(dNdS, fill=Arm) +
  geom_boxplot() +
  coord_flip() +
  facet_wrap(~seqnames) +
...
ggplot(tibble(as.data.frame(dndsPairs$Osa_Oki)) %>% filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR'))) +
  aes(dNdS, fill=Arm) +
  geom_boxplot() +
  coord_flip() +
  facet_wrap(~seqnames) +
  ggtitle('dN/dS by chromosome and chromosome arm for Osa/Oki')
ggplot(tibble(as.data.frame(dndsPairs$Osa_Bar)) %>% filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR'))) +
  aes(dNdS, fill=Arm) +
  geom_boxplot() +
  coord_flip() +
  facet_wrap(~seqnames) +
...
ggplot(tibble(as.data.frame(dndsPairs$Bar_Osa)) %>% filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR'))) +
  aes(dNdS, fill=Arm) +
  geom_boxplot() +
  coord_flip() +
  facet_wrap(~seqnames) +
...
ggplot(tibble(as.data.frame(dndsPairs$Bar_Oki)) %>% filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR'))) +
  aes(dNdS, fill=Arm) +
  geom_boxplot() +
  coord_flip() +
  facet_wrap(~seqnames) +
