...
dndsBlocks$Oki_Osa$blocksize_1_gene <- get_dnds(orthoBlocks$Oki_Osa, alignment_type="dNdS_GUIDANCE2", block_min_size=0, block_max_size=2)
# Subset to syntenic blocks with more than 1 gene.
dndsBlocks$Oki_Osa$blocksize_gt_1_gene <- get_dnds(orthoBlocks$Oki_Osa, alignment_type="dNdS_GUIDANCE2", block_min_size=2, block_max_size=Inf)
...
dndsBlocks$Oki_Bar$blocksize_1_gene <- get_dnds(orthoBlocks$Oki_Bar, alignment_type="dNdS_GUIDANCE2", block_min_size=0, block_max_size=2)
dndsBlocks$Oki_Bar$blocksize_gt_1_gene <- get_dnds(orthoBlocks$Oki_Bar, alignment_type="dNdS_GUIDANCE2", block_min_size=2, block_max_size=Inf)
...
dndsBlocks$Osa_Bar$blocksize_1_gene <- get_dnds(orthoBlocks$Osa_Bar, alignment_type="dNdS_GUIDANCE2", block_min_size=0, block_max_size=2)
dndsBlocks$Osa_Bar$blocksize_gt_1_gene <- get_dnds(orthoBlocks$Osa_Bar, alignment_type="dNdS_GUIDANCE2", block_min_size=2, block_max_size=Inf)
...
and as we have already observed, there is an arm-specific difference in dN/dS values.
