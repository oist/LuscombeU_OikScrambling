...
(p_boundary <- rbind(
  ...
  hmList_to_plot$unmap       |> prepareGGFreqPlot("02_unal_unmap"),
  hmList_to_plot$syn_block   |> prepareGGFreqPlot("03_synteny_blk"),
  hmList_to_plot$bri     |> prepareGGFreqPlot("04_unal_syntenic"),
  hmList_to_plot$aln_coa     |> prepareGGFreqPlot("05_aln_syntenic")
