...
We can filter most of them due to the fact that they do not coalesce.
See `vignette("RegionWidths", package = "OikScrambling")` for details.
...
plotHeatmapMeta(list(feature_coverage(current_GB_wide,   reps$Oki, win = 1e3, lab = "wide",    direction = "left")))
plotHeatmapMeta(list(feature_coverage(current_GB_narrow, reps$Oki, win = 1e3, lab = "narrow",  direction = "left")))
```
