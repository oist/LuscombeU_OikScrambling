...
current_GB_wide   <- coa$Oki_Osa |> subset(width >  500)
current_GB_narrow <- coa$Oki_Osa |> subset(width <= 500)
plotHeatmapMeta(list(feature_coverage(current_GB_wide,   intronicParts(annots$Oki), win = 1e3, lab = "wide")))
plotHeatmapMeta(list(feature_coverage(current_GB_narrow, intronicParts(annots$Oki), win = 1e3, lab = "narrow")))

plotHeatmapMeta(list(feature_coverage(current_GB_wide,   reps$Oki, win = 1e3, lab = "wide")))
plotHeatmapMeta(list(feature_coverage(current_GB_narrow, reps$Oki, win = 1e3, lab = "narrow")))
```
