...
prepareFreqPlot <- function(gb, annot, win = 1e3) {
  l <- list()
...
hmListW  <- prepareFreqPlot(current_GB_wide,    annots$Oki)
hmListN  <- prepareFreqPlot(current_GB_narrow,  annots$Oki)
hmListUA <- prepareFreqPlot(current_GB_unal,    annots$Oki)
hmListUM <- prepareFreqPlot(current_GB_unalMap, annots$Oki)

plotHeatmapMeta(hmListN)
plotHeatmapMeta(hmListW)
plotHeatmapMeta(hmListUA)
plotHeatmapMeta(hmListUM)
```
