...
prepareFreqPlot <- function(gb, annot, rep, cne = NULL, tfbs = NULL, operons = NULL, win = 1000, direction = "left") {
  l <- list()
...
computePlotData <- function(target, query, CE=NULL, tfbs=NULL, operons = NULL, direction = "left") {
  ...
  prepareFreqPlot_default <- \(x) prepareFreqPlot(x, annots[[target]], reps[[targetGenome]], CE, tfbs, operons[[target]], direction = direction)
