...
prepareFreqPlot <- function(gb, annot = NULL, rep = NULL, cne = NULL, tfbs = NULL, operons = NULL, win = 1000, direction = "left") {
  l <- list()
...
```{r genomic_features_byType_2, fig.width=15, fig.height=5, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
computePlotData_simplified <- function(target, query, annots=NULL, reps=NULL, CE=NULL, tfbs=NULL, operons=NULL, direction="left") {
  pair <- paste(target, query, sep = "_")
  current_GB_brk <- unmap[[pair]]
  current_GB_bri <- bri[[pair]]
...
hmList_to_plot_coding    <- computePlotData_simplified("Oki", "Osa", annots = annots, operons = operons, direction = "right")
