...
computePlotData <- function(target, query, CE=NULL, tfbs=NULL) {
  ...
  hmList <- SimpleList()
  hmList$aln_nonCoa <- prepareFreqPlot(current_GB_aln_nonCoa, annots[[target]], reps[[target]], CE, tfbs)
  hmList$aln_coa    <- prepareFreqPlot(current_GB_aln_coa,    annots[[target]], reps[[target]], CE, tfbs)
  hmList$syn_block  <- prepareFreqPlot(current_GB_syn_block,  annots[[target]], reps[[target]], CE, tfbs)
  hmList$unmap      <- prepareFreqPlot(current_GB_unmap,      annots[[target]], reps[[target]], CE, tfbs)
  hmList$unalMap    <- prepareFreqPlot(current_GB_unalMap,    annots[[target]], reps[[target]], CE, tfbs)
  hmList
}
