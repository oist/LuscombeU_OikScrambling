...
```{r}
# 5' ends of operons
current_GB <- operons$Oki |> promoters(0,1)

hmList_op_OKI <- list()
hmList_op_OKI$gbs <- feature_coverage(current_GB, gbs$Oki_Osa, win = 2000, lab = "Oki_Osa alns", direction = "left")
hmList_op_OKI$coa <- feature_coverage(current_GB, coa$Oki_Osa, win = 2000, lab = "Oki_Osa col reg", direction = "left")
hmList_op_OKI$bri <- feature_coverage(current_GB, bri$Oki_Osa, win = 2000, lab = "Oki_Osa bridge reg", direction = "left")

plotHeatmapMeta(hmList_op_OKI[c("gbs", "coa", "bri")])
```
