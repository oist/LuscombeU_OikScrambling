...
pho_sco <- pho2[pho2$Oki_SC && pho2$Osa_SC && pho2$Bar_SC, ]
...
pho2_sco$Oki_op_names_len <- lapply(pho2_sco$Oki_op_names, length) |> unlist()
pho2_sco$Osa_op_names_len <- lapply(pho2_sco$Osa_op_names, length) |> unlist()
pho2_sco$Bar_op_names_len <- lapply(pho2_sco$Bar_op_names, length) |> unlist()
pho2_sco_op <- pho2_sco[apply(pho2_sco[,19:21], 1, all),]
