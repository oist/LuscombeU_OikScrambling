...
current_GB_wide   <- gbs$Oki_Osa[ ! gbs$Oki_Osa$nonCoa] |> plyranges::arrange(width)
current_GB_narrow <- gbs$Oki_Osa[   gbs$Oki_Osa$nonCoa]
...
(p_boundary <- rbind(
  ...
  ggtitle("Aligned on regions left boundary"))
```
