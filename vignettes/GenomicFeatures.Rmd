...
See the `vignette("OperonDetection",
...
```{r prepare_functions_for_figure_plot}
...
```{r genomic_features_byType_Oki_Bar, fig.width=6, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r genomic_features_byType_Oki_Kum, fig.width=6, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r genomic_features_byType_Oki, fig.width=15, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
pOkiOsa + pOkiBar + pOkiKum + plot_layout(guides = 'collect')
```

## Osaka–Okinawa

```{r genomic_features_byType_Osa_Oki, fig.width=6, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r genomic_features_byType_Osa_bar, fig.width=6, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r genomic_features_byType_Osa_Aom, fig.width=6, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
...
```{r genomic_features_byType_Osa, fig.width=15, fig.height=8, dev=c("svg", "pdf", "png"), fig.ext=c("svg", "pdf", "png")}
