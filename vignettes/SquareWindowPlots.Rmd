...
```{r muntjaks, dev='svg', fig.ext='svg'}
...
```{r Cni_Cin_win, dev='svg', fig.ext='svg'}
...
```{r Cbr_Cel_win, dev=c('svg', 'pdf'), fig.ext=c('svg', 'pdf')}
