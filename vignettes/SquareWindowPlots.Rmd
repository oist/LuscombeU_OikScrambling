...
Figure 7 alignment panels were generated in this vignette.
...
On chromosome 3R there is a large unaligned region that causes the plot to not
...
Cnig_Cbri <- load_genomic_breaks("/bucket/LuscombeU/live/CharlesPlessy/ScramblingInTheTreeOfLife/Nematoda/results_Caenorhabditis_nigoni_GCA_027920645.1/last/Caenorhabditis_nigoni_GCA_027920645.1___Caenorhabditis_briggsae_GCA_022453885.1.07.postmasked.maf.gz")
# Removing CP115869.1 as it has a large nigni-specific region at the middle and it is the only one like that.
mkOxPlotWindow(Cnig_Cbri |> plyranges::filter(seqnames != "CP115869.1"), centre = 'maxwidth') + ggtitle("Caenorhabditis nigoni vs C. briggsae (61% aligned, 81% identity)")
```

## _C. nigoni_ vs _C. remanei_

```{r Cnig_Crem_win, dev='svg', fig.ext='svg'}
Cnig_Crem <- load_genomic_breaks("/bucket/LuscombeU/live/CharlesPlessy/ScramblingInTheTreeOfLife/Nematoda/results_Caenorhabditis_nigoni_GCA_027920645.1/last/Caenorhabditis_nigoni_GCA_027920645.1___Caenorhabditis_remanei_GCA_001643735.4.07.postmasked.maf.gz")
mkOxPlotWindow(Cnig_Crem, centre = 'maxwidth') + ggtitle("Caenorhabditis nigoni vs C. remanei (27% aligned, 67% identity)")
```

## _C. nigoni_ vs _C. inopinata_

```{r Cnig_Cino_win, dev='svg', fig.ext='svg'}
Cnig_Cino <- load_genomic_breaks("/bucket/LuscombeU/live/CharlesPlessy/ScramblingInTheTreeOfLife/Nematoda/results_Caenorhabditis_nigoni_GCA_027920645.1/last/Caenorhabditis_nigoni_GCA_027920645.1___Caenorhabditis_inopinata_GCA_003052745.1.07.postmasked.maf.gz")
mkOxPlotWindow(Cnig_Cino, centre = 'maxwidth') + ggtitle("Caenorhabditis nigoni vs C. inopinata (18% aligned, 68% identity)")
```
