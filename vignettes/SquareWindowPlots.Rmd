...
_C. nigoni_ genome assembly `GCA_027920645.1` length: 128508886.  It has no
unplaced contigs nor mitochondrial genome.

```{r Cnig_Cbri_win, dev='svg', fig.ext='svg'}
mkOxPlotWindow(gbs$Nig_Bri |> plyranges::filter(seqnames != "CP115869.1"), centre = 'maxwidth') + ggtitle("Caenorhabditis nigoni vs C. briggsae (61% aligned, 85% identity)")
```
...
mkOxPlotWindow(gbs$Nig_Ino, centre = 'maxwidth') + ggtitle("Caenorhabditis nigoni vs C. inopinata (16% aligned, 85% identity)")
```
