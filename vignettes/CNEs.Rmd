...
calculateCEs <- function(window, identity) {
  ...
  ce$Osa_Kum <- ceScan_to_GB(axt$Osa_Kum, window = window, identity = identity)
  ce$Osa_Olo <- ceScan_to_GB(axt$Osa_Olo, window = window, identity = identity)
  ce$Osa_Ova <- ceScan_to_GB(axt$Osa_Ova, window = window, identity = identity)
  ce$Osa_Oal <- ceScan_to_GB(axt$Osa_Oal, window = window, identity = identity)
  ...
  ce$Bar_Kum <- ceScan_to_GB(axt$Bar_Kum, window = window, identity = identity)
  ce$Bar_Aom <- ceScan_to_GB(axt$Bar_Aom, window = window, identity = identity)
  ce$Bar_Olo <- ceScan_to_GB(axt$Bar_Olo, window = window, identity = identity)
  ce$Bar_Ova <- ceScan_to_GB(axt$Bar_Ova, window = window, identity = identity)
  ce$Bar_Oal <- ceScan_to_GB(axt$Bar_Oal, window = window, identity = identity)
  ce
}
