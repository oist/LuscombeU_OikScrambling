...
seqinfo <- O97f
orientedSeqNames <- c("S10+", "S9+", "S32+", "S84-", "S59+", "S8-", "S1+", "S66-")

substr(orientedSeqNames, nchar(orientedSeqNames), nchar(orientedSeqNames))
...
scaffold(O97f, "XSR", orientedSeqNames)
