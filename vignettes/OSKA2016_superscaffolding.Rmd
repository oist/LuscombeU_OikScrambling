...
O97f <- load_genomic_breaks("~/FromSango/OSKA2016__O9-7f.gff.gz", target_bsgenome = OSKA2016, type = "match") |> coalesce_contigs()
...
O35f <- load_genomic_breaks("~/FromSango/OSKA2016__O3-5f.gff.gz", target_bsgenome = OSKA2016, type = "match") |> coalesce_contigs()
genome(O35f) <- "O35f"

OSK421f <- load_genomic_breaks("~/FromSango/OSKA2016__OSK42-2f.gff.gz", target_bsgenome = OSKA2016, type = "match") |> coalesce_contigs()
genome(OSK421f$query) <- "OSK421f"

AOM5.5f  <- load_genomic_breaks("~/FromSango/OSKA2016__AOM-5-5f.gff.gz", target_bsgenome = OSKA2016, query_bsgenome = BSgenome.Odioica.local.AOM.5, type = "match") |> coalesce_contigs()
AOM10.2f <- load_genomic_breaks("~/FromSango/OSKA2016__AOM-10-2f.gff.gz", target_bsgenome = OSKA2016, type = "match") |> coalesce_contigs()
...
OKI  <- load_genomic_breaks("~/FromSango/OSKA2016__OKI2018_I69_1.0.gff.gz", t = OSKA2016, q = BSgenome.Odioica.local.OKI2018.I69, type = "match") |> coalesce_contigs()
BAR  <- load_genomic_breaks("~/FromSango/OSKA2016__Bar2_p4.gff.gz",         t = OSKA2016, q = BSgenome.Odioica.local.Bar2.p4,     type = "match") |> coalesce_contigs()
```
