...
scaffold <- function(seqinfo, newname, seqnames, orientations) {
...
scaffold <- scaffold(O97f, "XSR", listofnames, orientations)

gr <- O97f
newname <- "XSR"
scaffold

assemble <- function(gr, scaffold) {
  newname <- unique(seqnames(scaffold)) |> as.character()
  ...
  mergeSeqLevels(gr, names(scaffold), newname)
}

assemble(O97f, scaffold)
```
