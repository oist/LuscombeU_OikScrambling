...
if (!file.exists("gadems.invs.Rds")) {
  ...
  saveRDS(gadems$inv.lgaps, file = "gadems.invs.Rds")
} else {
...
if (!file.exists("gadems.proms.Rds")) {
  gadems$invs <- BiocParallel::bplapply(prom_seqs, doGadem) |> SimpleList()
  saveRDS(gadems$inv.lgaps, file = "gadems.proms.Rds")
} else {
...
if (!file.exists("gadems.introns.Rds")) {
  ...
  saveRDS(gadems$inv.lgaps, file = "gadems.introns.Rds")
} else {
