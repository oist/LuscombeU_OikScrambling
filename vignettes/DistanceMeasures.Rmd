...
randomly_flip_strand(gbs$Oki_Osa, times=1000, threads=4, method='mle') |> unlist() |> hist(xlim=c(0,0.1), main="Oki-Osa: Histogram of random run length SRIs (MLE)", xlab='run length') |> abline(v=strand_randomisation_index(gbs$Oki_Osa), col='darkred') |> text(x=strand_randomisation_index(gbs$Oki_Osa), y=150,  label="overall", col='darkred') |> abline( v=gbs$Oki_Osa |> plyranges::filter(Arm=="short") |> strand_randomisation_index(), lty=3, col='#595959'  ) |> text(x=gbs$Oki_Osa |> plyranges::filter(Arm=="short") |> strand_randomisation_index(), y=150,  label="short", col='#595959') |> abline( v=gbs$Oki_Osa |> plyranges::filter(Arm=="long") |> strand_randomisation_index(), lty=3, col='#595959'  )  |> text(x=gbs$Oki_Osa |> plyranges::filter(Arm=="long") |> strand_randomisation_index(), y=150, label="long", col='#595959')

# Make sure that the origin of the strand distribution doesn't affect the randomisation too much
check_arm_rl_variance <- list(
  overall1=unlist(randomly_flip_strand(gbs$Oki_Osa, times=1000, threads=4, method='mle', seed = 1234)),
  short1=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="short"), times=1000, threads=4, method='mle', seed = 1234)),
  long1=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="long"), times=1000, threads=4, method='mle', seed = 1234)), 
  
  overall2=unlist(randomly_flip_strand(gbs$Oki_Osa, times=1000, threads=4, method='mle', seed = 4321)),
  short2=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="short"), times=1000, threads=4, method='mle', seed = 4321)),
  long2=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="long"), times=1000, threads=4, method='mle', seed = 4321)),
  
  overall3=unlist(randomly_flip_strand(gbs$Oki_Osa, times=1000, threads=4, method='mle', seed = 6789)),
  short3=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="short"), times=1000, threads=4, method='mle', seed = 6789)),
  long3=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="long"), times=1000, threads=4, method='mle', seed = 6789)), 
  
  overall4=unlist(randomly_flip_strand(gbs$Oki_Osa, times=1000, threads=4, method='mle', seed = 9876)),
  short4=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="short"), times=1000, threads=4, method='mle', seed = 9876)),
  long4=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="long"), times=1000, threads=4, method='mle', seed = 9876)),
  
  overall5=unlist(randomly_flip_strand(gbs$Oki_Osa, times=1000, threads=4, method='mle', seed = 4567)),
  short5=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="short"), times=1000, threads=4, method='mle', seed = 4567)),
  long5=unlist(randomly_flip_strand(gbs$Oki_Osa |> plyranges::filter(Arm=="long"), times=1000, threads=4, method='mle', seed = 4567)) 
)
