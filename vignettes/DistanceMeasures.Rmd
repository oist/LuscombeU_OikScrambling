...
sapply(gbs, synteny_index) |> pairs2table6x3() |> round(2)

sapply(gbs, \(g) swap(g) |> synteny_index())  |> pairs2table6x3() |> round(2)
```
...
```{r correlation_index}
sapply(gbs, correlation_index) |> pairs2table6x3() |> round(2)
sapply(gbs, \(g) swap(g) |> correlation_index()) |> pairs2table6x3() |> round(2)
```
...
```{r goc_index}
sapply(gbs, GOC) |> pairs2table6x3() |> round(2)
sapply(gbs, \(g) swap(g) |> GOC()) |> pairs2table6x3() |> round(2)
```
