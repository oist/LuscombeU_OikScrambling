...
This vignette produced panels used in Figures 5 and S5, see its table of
contents to jump directly where they were computed.

In this vignette, we develop some of the materials needed to produce plots that
summarize genomic data at chromosome-scale.
...
(binApply(mean, tmp, transcripts$Oki$dNdS_PRANK, matchToOneBin(transcripts$Oki, tmp), na.rm = TRUE)) |> head(100)
...
(metaPerWindow(genomeWindows=tmp, transcripts$Oki, meta_prefix = 'transcripts.'))[120:130]
...
(grWindows(genomes$Oki, transcripts$Oki, meta_prefix = "transcripts"))[120:130]
```
...
```{r chromosome_plots_transcripts_oki, dependson="chromosome_plots_transcripts", fig.height=5, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_transcripts_osa, dependson="chromosome_plots_transcripts", fig.height=5, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
# Density of transcript names (i.e., gene counts).
...
```{r chromosome_plots_transcripts_bar, dependson="chromosome_plots_transcripts", fig.height=5, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
# Density of transcript names (i.e., gene counts).
...
See also the repeat classes in the Extra section.
...
```{r chromosome_plots_scores_osa, dependson="chromosome_plots_scores", fig.height=6, fig.width=8, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_scores_bar, dependson="chromosome_plots_scores", fig.height=6, fig.width=8, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_widths_osa, dependson="chromosome_plot_helper_fxns", fig.height=6, fig.width=8, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_widths_bar, dependson="chromosome_plot_helper_fxns", fig.height=6, fig.width=8, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
p1_c <- ggplot(tmp) + aes(x=bp.mean.breaks, y=transcripts.dNdS_PRANK.median) + geom_point() + geom_smooth(method='lm', col='red') + ggpubr::stat_cor() + facet_wrap(seqnames~Arm, ncol=2, scales = 'free') + ggtitle('Okinawa: Breakpoints vs. dN/dS') + ylab('dN/dS')
```
...
p2_c <- ggplot(tmp) + aes(x=bp.mean.breaks, y=transcripts.dNdS_PRANK.median) + geom_point() + geom_smooth(method='lm', col='red') + ggpubr::stat_cor() + facet_wrap(seqnames~Arm, ncol=2, scales = 'free') + ggtitle('Osaka: Breakpoints vs. dN/dS') + ylab('dN/dS')
```
...
p3_c <- ggplot(tmp) + aes(x=bp.mean.breaks, y=transcripts.dNdS_PRANK.median) + geom_point() + geom_smooth(method='lm', col='red') + ggpubr::stat_cor() + facet_wrap(seqnames~Arm, ncol=2, scales = 'free') + ggtitle('Barcelona: Breakpoints vs. dN/dS') + ylab('dN/dS')
```
...
plots$Oki$boxplots$dnds <- ggboxplot(tb, x='seqnames_arm', y='transcripts.dNdS_PRANK.median', color='seqnames', add='jitter') +
  theme(axis.text.x=element_text(angle=90)) +
...
plots$Osa$boxplots$dnds <- ggboxplot(tb, x='seqnames_arm', y='transcripts.dNdS_PRANK.median', color='seqnames', add='jitter') +
  theme(axis.text.x=element_text(angle=90)) +
  ylab('median dN/dS per window') +
  stat_compare_means(comparison=list(c('Chr1_short', 'Chr1_long'), c('Chr2_short', 'Chr2_long'), c('PAR_short', 'PAR_long'), c('XSR_XSR', 'PAR_short'), c('XSR_XSR', 'PAR_long'))) +
...
plots$Bar$boxplots$dnds <- ggboxplot(tb, x='seqnames_arm', y='transcripts.dNdS_PRANK.median', color='seqnames', add='jitter') +
  theme(axis.text.x=element_text(angle=90)) +
  ylab('median dN/dS per window') +
  stat_compare_means(comparison=list(c('Chr1_short', 'Chr1_long'), c('Chr2_short', 'Chr2_long'), c('PAR_short', 'PAR_long'), c('XSR_XSR', 'YSR_YSR'), c('XSR_XSR', 'PAR_short'), c('XSR_XSR', 'PAR_long'))) +
...
```{r chromosome_plots_statistics_2_transcripts, fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```
```{r chromosome_plots_statistics_2_operons, fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
(plots$Oki$boxplots$operon_density + plots$Osa$boxplots$operon_density + plots$Bar$boxplots$operon_density) /
(plots$Oki$boxplots$operon_size    + plots$Osa$boxplots$operon_size    + plots$Bar$boxplots$operon_size)
```
```{r chromosome_plots_statistics_2_dnds, fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
plots$Oki$boxplots$dnds + plots$Osa$boxplots$dnds + plots$Bar$boxplots$dnds
```
...
chrt_unified$transcripts.dNdS.mean <- data.frame(chrt_unified$Oki.transcripts.dNdS_PRANK.median, chrt_unified$Osa.transcripts.dNdS_PRANK.median, chrt_unified$Bar.transcripts.dNdS_PRANK.median) |> rowMeans()
...
```{r chromosome_plots_tiles_2, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=14, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_3, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=14, message=FALSE, warning=FALSE, dev=c("svg", "png")}
tb <- chrt_unified |> as.data.frame()
tb$seqnames_arm <- paste0(tb$seqnames, "_", tb$Oki.Arm)
...
```{r chromosome_plots_tiles_5_2, dependson="chromosome_plots_tiles_calcs", fig.height=5, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
library(ggpubr)
...
```{r chromosome_plots_tiles_5_2_all, dependson="chromosome_plots_tiles_calcs_fig4", fig.height=10, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
(p2 / p3 / p4 / p5 / p6 / p7 / p8) # all plots
```
...
```{r chromosome_plots_tiles_5_2_Fig4A, dependson="chromosome_plots_tiles_calcs_fig4", fig.height=6, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
(p5 / p7 / p6) # Figure 4A
```

## Figure 5B

```{r chromosome_plots_tiles_5_2_Fig4B, dependson="chromosome_plots_tiles_calcs_fig4", fig.height=4, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
(p10 + p11 + p12) + plot_layout(guides = 'collect') # Figure 4B
```

## Figure 5 - outliers excluded
```{r chromosome_plots_tiles_5_3_Fig4A, dependson="chromosome_plots_tiles_calcs_fig4", fig.height=6, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
p6o <- tb |> per_chrom_plot() + aes(y=transcripts.dNdS.mean)   + ylab('dN/dS') + ylim(c(min(tb$transcripts.dNdS.mean), 0.10))

(p5 / p7 / p6o) # Figure 4A
```

## Figure 5B - outliers excluded
```{r chromosome_plots_tiles_5_3_Fig4B, dependson="chromosome_plots_tiles_calcs_fig4", fig.height=4, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png", "pdf"), fig.ext=c("svg", "png", "pdf")}
library(ggpubr)
p12o <- ggboxplot(tb |> filter(transcripts.dNdS.mean < 0.10), x='Arm', y='transcripts.dNdS.mean', color='Oki.Arm', add='jitter') + theme(axis.text.x=element_text(angle=90)) + ylab('dN/dS') + stat_compare_means(comparison=list(c('short', 'long'), c('short', 'XSR'), c('long', 'XSR')), paired = FALSE, na.rm = TRUE, method='t.test', size=2.8) + theme_bw() 

(p10 + p11 + p12o) + plot_layout(guides = 'collect') # Figure 4B
detach('package:ggpubr')
...
See the [Figure S5 subsection of the Repeats section above](#supplemental-figure-S5).
...
```{r chromosome_plots_tiles_5_4, dependson="chromosome_plots_tiles_calcs", fig.height=10, fig.width=6, message=FALSE, warning=FALSE, dev=c("svg", "png")}
tb <- chrt_unified |> as.data.frame()
tb$seqnames_arm <- paste0(tb$seqnames, "_", tb$Oki.Arm)
...
```{r chromosome_plots_tiles_5_5, dependson="chromosome_plots_tiles_calcs", fig.height=12, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
library(ggpubr)
tb <- chrt_unified |> as.data.frame()
tb$seqnames_arm <- paste0(tb$seqnames, "_", tb$Oki.Arm)
...
### Version with boxplots superimposed on chromosomes.

```{r chromosome_plots_tiles_7_1, dependson="chromosome_plots_tiles_calcs", fig.height=5, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
library(ggpubr)
tb <- chrt_unified |> as.data.frame()
tb$seqnames_arm <- paste0(tb$seqnames, "_", tb$Oki.Arm)
...
```{r chromosome_plots_tiles_7_1_all, dependson="chromosome_plots_tiles_calcs", fig.height=8, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
( p0 / p1 / p2 / p3 / p4 )
```
...
p1 <- chrt_unified |> as.data.frame() |> ggplot() + aes(start, Oki.transcripts.dNdS_PRANK.median, col=Oki.Arm) + facet_wrap(~seqnames, nrow=1) + geom_point() + geom_smooth(method='loess', formula=y~x, span=0.25, se=T, method.args=list(family="symmetric"))
p2 <- chrt_unified |> as.data.frame() |> ggplot() + aes(start, Osa.transcripts.dNdS_PRANK.median, col=Osa.Arm) + facet_wrap(~seqnames, nrow=1) + geom_point() + geom_smooth(method='loess', formula=y~x, span=0.25, se=T, method.args=list(family="symmetric"))
p3 <- chrt_unified |> as.data.frame() |> ggplot() + aes(start, Bar.transcripts.dNdS_PRANK.median, col=Bar.Arm) + facet_wrap(~seqnames, nrow=1) + geom_point() + geom_smooth(method='loess', formula=y~x, span=0.25, se=T, method.args=list(family="symmetric"))
(p1 / p2 / p3)
```
...
p1 <- chrt_unified |> as.data.frame() |> ggplot() + aes(start, Oki.transcripts.dNdS_PRANK.median, col=Oki.Arm) + facet_wrap(~seqnames, nrow=1) + geom_point() + geom_smooth(method='loess', formula=y~x, span=0.25, se=T)

p2 <- chrt_unified |> as.data.frame() |> ggplot() + aes(start, Osa.transcripts.dNdS_PRANK.median, col=Osa.Arm) + facet_wrap(~seqnames, nrow=1) + geom_point() + geom_smooth(method='loess', formula=y~x, span=0.25, se=T)

p3 <- chrt_unified |> as.data.frame() |> ggplot() + aes(start, Bar.transcripts.dNdS_PRANK.median, col=Bar.Arm) + facet_wrap(~seqnames, nrow=1) + geom_point() + geom_smooth(method='loess', formula=y~x, span=0.25, se=T)
...
p1 <- ggplot( chrt_unified |> as.data.frame() ) + aes(x=start, y=Oki.transcripts.dNdS_PRANK.median, col = Oki.Arm) + geom_point() + facet_wrap(~seqnames, nrow = 1) + geom_smooth(formula=y~x, method = 'loess') + ylab('dN/dS')
...
p4 <- ggboxplot(tb, x='seqnames_arm', y='Oki.transcripts.dNdS_PRANK.median', color='Oki.Arm', add='jitter') +
  theme(axis.text.x=element_text(angle=90)) +
  ylab('dN/dS') +
  stat_compare_means(comparison=list(c('Chr1_short', 'Chr1_long'), c('Chr2_short', 'Chr2_long'), c('PAR_short', 'PAR_long'), c('XSR_XSR', 'PAR_short'), c('XSR_XSR', 'PAR_long')), paired = FALSE, na.rm = TRUE, method='t.test') + theme_classic()

p5 <- ggplot(tb) + aes(x=Oki.bp.Oki_Osa.breaks.count, y=Oki.transcripts.dNdS_PRANK.median) + geom_point() + geom_smooth(method='lm', col='red', formula=y~x) + ggpubr::stat_cor() + facet_wrap(seqnames~Oki.Arm, nrow=1, scales = 'free') + ylab('dN/dS')
...
p4 <- tb |> customGGboxplot('Oki.transcripts.dNdS_PRANK.median', 'dN/dS')

p5 <- tb |> customCorrelationPlot('Oki.bp.Oki_Bar.breaks.count', 'Oki.transcripts.dNdS_PRANK.median',  'breakpoints', 'dN/dS')
...
```{r chromosome_plots_tiles_9_osa_bar, dependson="chromosome_plots_tiles_calcs", fig.height=12, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
tb <- chrt_unified |> as.data.frame()
tb$seqnames_arm <- paste0(tb$seqnames, "_", tb$Osa.Arm)
tb$Arm <- tb$Osa.Arm

p1 <- tb |> per_chrom_plot() + aes(y=Osa.transcripts.dNdS_PRANK.median, col = Arm) + ylab('dN/dS')
...
p4 <- tb |> customGGboxplot('Osa.transcripts.dNdS_PRANK.median', 'dN/dS')

p5 <- tb |> customCorrelationPlot('Osa.bp.Osa_Bar.breaks.count', 'Osa.transcripts.dNdS_PRANK.median',  'breakpoints', 'dN/dS')
...
```{r chromosome_plots_tiles_9_oki_kum, dependson="chromosome_plots_tiles_calcs", fig.height=12, fig.width=10, message=FALSE, warning=FALSE, dev=c("svg", "png")}
tb$seqnames_arm <- paste0(tb$seqnames, "_", tb$Oki.Arm)
tb$Arm <- tb$Oki.Arm

p1 <- tb |> per_chrom_plot() + aes(y=Oki.transcripts.dNdS_PRANK.median, col = Arm) + ylab('dN/dS')
...
p5 <- tb |> customCorrelationPlot('Oki.bp.Oki_Kum.breaks.count', 'Oki.transcripts.dNdS_PRANK.median',  'breakpoints', 'dN/dS')
...
```{r all_oki_oik_feats, fig.height=12, fig.width=6, message=FALSE, warning=FALSE, dev=c("svg", "png")}
(
  (chrw$Oki |>
