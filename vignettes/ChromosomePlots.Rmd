...
(p$Oki$txcount <- chrw$Oki |> per_chrom_plot(Y=TRUE) + aes(y=transcripts.tx_name.count) +  ggtitle(paste("Okinawa: transcripts per window (size = ", windowSize/1000, " kbp)", sep="")) +
  geom_vline( data = (longShort$OKI2018.I69 -1) |> GenomicBreaks::cleanGaps() |> as.data.frame()
            , aes(xintercept = start), col = "gray"))

# dN/dS
(p$Oki$dNdS <- chrw$Oki |> per_chrom_plot() + aes(y=transcripts.dNdS_PRANK.median)+ ggtitle(paste("Okinawa: dN/dS per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
# Density of transcript names (i.e., gene counts).
(p$Osa$txcount <- chrw$Osa |> per_chrom_plot(Y=TRUE) + aes(y=transcripts.tx_name.count) +  ggtitle(paste("Osaka: transcripts per window (size = ", windowSize/1000, " kbp)", sep="")) +
  geom_vline( data = (longShort$OSKA2016v1.9 -1) |> GenomicBreaks::cleanGaps() |> as.data.frame()
            , aes(xintercept = start), col = "gray"))

# dN/dS
(p$Osa$dNdS <- chrw$Osa |> per_chrom_plot() + aes(y=transcripts.dNdS_PRANK.median)+ ggtitle(paste("Osaka: dN/dS per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
# Density of transcript names (i.e., gene counts).
(p$Bar$txcount <- chrw$Bar |> per_chrom_plot(Y=TRUE) + aes(y=transcripts.tx_name.count) +  ggtitle(paste("Barcelona: transcripts per window (size = ", windowSize/1000, " kbp)", sep="")) +
  geom_vline( data = (longShort$Bar2.p4 -1) |> GenomicBreaks::cleanGaps() |> as.data.frame()
            , aes(xintercept = start), col = "gray"))

# dN/dS
(p$Bar$dNdS <- chrw$Bar |> per_chrom_plot() + aes(y=transcripts.dNdS_PRANK.median)+ ggtitle(paste("Barcelona: dN/dS per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
ggpubr::ggarrange(p$Oki$txcount, p$Osa$txcount, p$Bar$txcount, ncol=1)
```
...
ggpubr::ggarrange(p$Oki$dNdS, p$Osa$dNdS, p$Bar$dNdS, ncol=1)
```
...
(p$Oki$opcount <- chrw$Oki |> per_chrom_plot(Y=TRUE) + aes(y=operons.n.count) +  ggtitle(paste("Okinawa: operons per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
(p$Osa$opcount <- chrw$Osa |> per_chrom_plot(Y=TRUE) + aes(y=operons.n.count) +  ggtitle(paste("Osaka: operons per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
(p$Bar$opcount <- chrw$Bar |> per_chrom_plot(Y=TRUE) + aes(y=operons.n.count) +  ggtitle(paste("Barcelona: operons per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
(p$Oki$repcount <- chrw$Oki |> per_chrom_plot(Y=TRUE) + aes(y=repeats.Class.count.total) +  ggtitle(paste("Okinawa: repeats per window (size = ", windowSize/1000, " kbp)", sep="")))

(p$Osa$repcount <- chrw$Osa |> per_chrom_plot(Y=TRUE) + aes(y=repeats.Class.count.total) +  ggtitle(paste("Osaka: repeats per window (size = ", windowSize/1000, " kbp)", sep="")))

(p$Bar$repcount <- chrw$Bar |> per_chrom_plot(Y=TRUE) + aes(y=repeats.Class.count.total) +  ggtitle(paste("Barcelona: repeats per window (size = ", windowSize/1000, " kbp)", sep="")))
```
...
ggpubr::ggarrange(p$Oki$repcount, p$Osa$repcount, p$Bar$repcount, ncol=1)
```
...
(p$Oki$OsaAlScore <- chrw$Oki |> per_chrom_plot(Y=TRUE) + aes(y=Oki_Osa.score.mean) +  ggtitle("Oki-Osa: Chromosomal position vs. alignment score"))

(p$Oki$BarAlScore <- chrw$Oki |> per_chrom_plot(Y=TRUE) + aes(y=Oki_Bar.score.mean) +  ggtitle("Oki-Bar: Chromosomal position vs. alignment score"))

(p$Oki$AlScores <- chrw$Oki |>
  as.data.frame() |>
...
ggpubr::ggarrange(p$Oki$AlScores, p$Osa$AlScores, p$Bar$AlScores, ncol=1)
```
