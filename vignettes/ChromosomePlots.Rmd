...
chrt_unified |> flag_subtelomeric_pericentromeric() |> sort() -> chrt_unified_edge
chrt_unified_edge$chr.arm.label |> table()
```


```{chromosome_arm_edges_5, dependson="chromosome_arm_edges", fig.height=6, fig.width=8, message=FALSE, warning=FALSE, dev=c("svg", "png")}
library(ggpubr)
compare_method = "t.test"
#compare_method = "wilcox.test"
