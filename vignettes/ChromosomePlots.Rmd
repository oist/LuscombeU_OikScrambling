...
# Correlation plots, relating number of 
...
p3 <- ggplot(tb) + aes(x=breakpoints.count.mean, y=categories.unmapped.mean) + geom_point() + geom_smooth(method='lm', col='red' , formula=y~x) + ggpubr::stat_cor() + facet_wrap(seqnames~Oki.Arm, nrow=1, scales = 'free') + ylab('unmapped')
