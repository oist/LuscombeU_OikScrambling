...
plots$Oki$operons$density_1 <- ggplot(chrw$Oki |> as.data.frame() |> plyranges::filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR', 'YSR')) ) + aes(x=start, y=operons.n.count) + geom_point() + facet_wrap(~seqnames) + geom_smooth() + ggtitle(paste("Okinawa: operons per window (size = ", windowSize/1000, " kbp)", sep="")) + geom_vline( data = (longShort$OKI2018.I69 -1) |> GenomicBreaks::cleanGaps() |> as.data.frame(), aes(xintercept = start), col = "gray")
...
plots$Oki$operons$length_1 <- ggplot(chrw$Oki |> as.data.frame() |> plyranges::filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR', 'YSR')) ) + aes(x=start, y=operons.n.mean) + geom_point() + facet_wrap(~seqnames) + geom_smooth() + ggtitle(paste("Okinawa: mean operon size per window (size = ", windowSize/1000, " kbp)", sep="")) + geom_vline( data = (longShort$OKI2018.I69 -1) |> GenomicBreaks::cleanGaps() |> as.data.frame(), aes(xintercept = start), col = "gray")
...
plots$Osa$operons$length_1 <- ggplot(chrw$Osa |> as.data.frame() |> plyranges::filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR')) ) + aes(x=start, y=operons.n.mean) + geom_point() + facet_wrap(~seqnames) + geom_smooth() + ggtitle(paste("Osaka: mean operon size per window (size = ", windowSize/1000, " kbp)", sep="")) + geom_vline( data = (longShort$OSKA2016v1.9 -1) |> GenomicBreaks::cleanGaps() |> as.data.frame(), aes(xintercept = start), col = "gray")
...
makeWholeGenomeObject <- function(aligned, unaligned) {
  ...
  unmapped  <- unaligned[unaligned$nonCoa]
  ...
  isolated$nonCoa <- collinear$nonCoa <- unmapped$nonCoa <- bridge$nonCoa <- NULL
  isolated$type   <- 'isolated'
  collinear$type  <- 'collinear'
  unmapped$type   <- 'unmapped'
  bridge$type     <- 'bridge'

  wholeGenome <- c(isolated, collinear, unmapped, bridge) |> sort(ignore.strand = TRUE)
...
chrw$Oki$ac.unmapped.mean <- chrw$Oki |> as.data.frame()|> select("ac.Oki_Osa.type.unmapped.count.total", "ac.Oki_Bar.type.unmapped.count.total", "ac.Oki_Kum.type.unmapped.count.total", "ac.Oki_Aom.type.unmapped.count.total", "ac.Oki_Nor.type.unmapped.count.total") |> as.data.frame() |> rowMeans()
...
plots$Oki$categories$oki_osa_classes <- chrw$Oki |>
  as.data.frame() |>
  subset(select=c("seqnames", "start", "end", "ac.Oki_Osa.type.isolated.count.total", "ac.Oki_Osa.type.collinear.count.total", "ac.Oki_Osa.type.unmapped.count.total", "ac.Oki_Osa.type.bridge.count.total" )) |>
  plyranges::filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR')) |>
  tidyr::pivot_longer(c("ac.Oki_Osa.type.isolated.count.total", "ac.Oki_Osa.type.collinear.count.total", "ac.Oki_Osa.type.unmapped.count.total", "ac.Oki_Osa.type.bridge.count.total")) |>
  ggplot() +
    aes(start, value, col = name) +
    facet_wrap(~seqnames, nrow = 1) +
    geom_smooth(method='loess', formula = y ~ x, span = 0.25, se = FALSE) +
...
plots$Oki$categories$oki_osa_overall <- chrw$Oki |>
  as.data.frame() |>
  subset(select=c("seqnames", "start", "end", "Arm", "ac.Oki_Osa.type.isolated.count.total", "ac.Oki_Osa.type.collinear.count.total", "ac.Oki_Osa.type.unmapped.count.total", "ac.Oki_Osa.type.bridge.count.total" )) |>
  plyranges::filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR')) |>
 tidyr::pivot_longer(c("ac.Oki_Osa.type.isolated.count.total", "ac.Oki_Osa.type.collinear.count.total", "ac.Oki_Osa.type.unmapped.count.total", "ac.Oki_Osa.type.bridge.count.total")) |>
  ggplot() +
...
plots$Oki$categories$mean_classes <- chrw$Oki |>
  as.data.frame() |>
  subset(select=c("seqnames", "start", "end", "Arm", "ac.isolated.mean", "ac.collinear.mean", "ac.unmapped.mean", "ac.bridge.mean" )) |>
  plyranges::filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR')) |>
 tidyr::pivot_longer(c("ac.isolated.mean", "ac.collinear.mean", "ac.unmapped.mean", "ac.bridge.mean")) |>
  ggplot() +
    aes(start, value, col = name) +
    facet_wrap(~seqnames, nrow = 1) +
    geom_smooth(method='loess', formula = y ~ x, span = 0.25, se = FALSE) +
...
p2 <- ggplot(as.data.frame(chrw$Oki) |> plyranges::filter(seqnames %in% c('chr1', 'chr2', 'PAR', 'XSR', 'YSR')) ) + geom_boxplot(aes(x=paste0(seqnames, "_", Arm), y=operons.n.count, fill=seqnames)) + ylab("median transcript length") + xlab(NULL) + theme(axis.text.x=element_text(angle=90)) + ggtitle("Okinawa: operon density by chr and arm")
...
p4 <- ggplot(as.data.frame(chrw$Osa) |> plyranges::filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR')) ) + geom_boxplot(aes(x=paste0(seqnames, "_", Arm), y=operons.n.count, fill=seqnames)) + ylab("median transcript length") + xlab(NULL) + theme(axis.text.x=element_text(angle=90)) + ggtitle("Osa: operon size by chr and arm")
...
p6 <- ggplot(as.data.frame(chrw$Bar) |> plyranges::filter(seqnames %in% c('Chr1', 'Chr2', 'PAR', 'XSR', 'YSR')) ) + geom_boxplot(aes(x=paste0(seqnames, "_", Arm), y=operons.n.count, fill=seqnames)) + ylab("median transcript length") + xlab(NULL) + theme(axis.text.x=element_text(angle=90)) + ggtitle("Bar: operon size by chr and arm")
...
# Operons
mcols(chrt$Oki) <- cbind(mcols(chrt$Oki), mcols(grTiles(genome=genomes$Oki, meta=OikScrambling:::calcOperons(transcripts$Oki), n=nTiles, meta_prefix = 'operons.')))
mcols(chrt$Osa) <- cbind(mcols(chrt$Osa), mcols(grTiles(genome=genomes$Osa, meta=OikScrambling:::calcOperons(transcripts$Osa), n=nTiles, meta_prefix = 'operons.')))
mcols(chrt$Bar) <- cbind(mcols(chrt$Bar), mcols(grTiles(genome=genomes$Bar, meta=OikScrambling:::calcOperons(transcripts$Bar), n=nTiles, meta_prefix = 'operons.')))
...
chrt$Oki$ac.unmapped.mean <- chrt$Oki |> as.data.frame()|> select("ac.Oki_Osa.type.unmapped.count.total", "ac.Oki_Bar.type.unmapped.count.total", "ac.Oki_Kum.type.unmapped.count.total", "ac.Oki_Aom.type.unmapped.count.total", "ac.Oki_Nor.type.unmapped.count.total") |> as.data.frame() |> rowMeans()
...
chrt$Osa$ac.unmapped.mean <- chrt$Osa |> as.data.frame()|> select("ac.Osa_Oki.type.unmapped.count.total", "ac.Osa_Bar.type.unmapped.count.total", "ac.Osa_Kum.type.unmapped.count.total", "ac.Osa_Aom.type.unmapped.count.total", "ac.Osa_Nor.type.unmapped.count.total") |> as.data.frame() |> rowMeans()
...
chrt$Bar$ac.unmapped.mean <- chrt$Bar |> as.data.frame()|> select("ac.Bar_Oki.type.unmapped.count.total", "ac.Bar_Osa.type.unmapped.count.total", "ac.Bar_Kum.type.unmapped.count.total", "ac.Bar_Aom.type.unmapped.count.total", "ac.Bar_Nor.type.unmapped.count.total") |> as.data.frame() |> rowMeans()
...
chrt_unified <- data.frame(seqnames=c(rep('Chr1', 100), rep('Chr2', 100), rep('PAR', 100), rep('XSR', 100)), start=c(seq(1, 100), seq(1, 100), seq(1, 100), seq(1, 100)), end=c(seq(1, 100)+1, seq(1, 100)+1, seq(1, 100)+1, seq(1, 100)+1) )  |> GRanges()
...
chrt_unified$categories.unmapped.mean <- data.frame(chrt_unified$Oki.ac.unmapped.mean, chrt_unified$Osa.ac.unmapped.mean, chrt_unified$Bar.ac.unmapped.mean) |> rowMeans()
...
```{r chromosome_plots_tiles_1_points, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
p1 <- ggplot( chrt_unified |> as.data.frame() ) + aes(x=start, y=transcripts.dNdS.mean, col = Oki.Arm) + geom_point() + facet_wrap(~seqnames, nrow = 1) + geom_smooth(formula=y~x, method = 'loess', method.args = list(family = "symmetric")) + ylab('dN/dS') 
p1 + ggtitle("Tiles (averages across Oki, Osa, Bar): Properties across genome")

p2 <- ggplot( chrt_unified |> as.data.frame() ) + aes(x=start, y=breakpoints.count.mean , col = Oki.Arm) + geom_point() + facet_wrap(~seqnames, nrow = 1) + geom_smooth(formula=y~x, method = 'loess', method.args = list(family = "symmetric")) + ylab('breakpoints') 
...
ggplot(chrt_unified |> as.data.frame()) +
  ...
  geom_smooth(aes(x=start, y=categories.unmapped.mean,  col='unmapped'), se=FALSE) +
...
chrt_unified |>
  as.data.frame() |>
  subset(select=c("seqnames", "start", "end", "Oki.Arm", "categories.isolated.mean", "categories.collinear.mean", "categories.unmapped.mean", "categories.bridge.mean" )) |>
 tidyr::pivot_longer(c("categories.isolated.mean", "categories.collinear.mean", "categories.unmapped.mean", "categories.bridge.mean")) |>
  ggplot() +
...
```{r chromosome_plots_tiles_4, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
library(ggpubr)
...
( p1 / p3 / p2 / p4 / p5 ) +   plot_layout(design = layout, guides = 'collect')
...
```{r chromosome_plots_tiles_5_bp_symmetric, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_5_dnds_symmetric, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_5_bp_nonsymmetric, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_5_dnds_nonsymmetric, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_7_oki_osa, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_7_oki_bar, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
p1 <- ggplot( chrt_unified |> as.data.frame() ) + aes(x=start, y=Oki.transcripts.dNdS_GUIDANCE2.median, col = Oki.Arm) + geom_point() + facet_wrap(~seqnames, nrow = 1) + geom_smooth(formula=y~x, method = 'loess') + ylab('dN/dS')
...
```{r chromosome_plots_tiles_7_osa_bar, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
...
```{r chromosome_plots_tiles_7_oki_kum, dependson="chromosome_plots_tiles_calcs", fig.height=6, fig.width=12, message=FALSE, warning=FALSE, dev=c("svg", "png")}
p1 <- ggplot( chrt_unified |> as.data.frame() ) + aes(x=start, y=Oki.transcripts.dNdS_GUIDANCE2.median, col = Oki.Arm) + geom_point() + facet_wrap(~seqnames, nrow = 1) + geom_smooth(formula=y~x, method = 'loess') + ylab('dN/dS')
